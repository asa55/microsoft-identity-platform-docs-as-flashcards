...
- The flashcards in this deck are derived from these official docs: [learn.microsoft.com/azure/active-directory/develop/](https://learn.microsoft.com/azure/active-directory/develop/)
- These flashcards are maintained in a GitHub repository, here: [`microsoft-identity-platform-docs-as-flashcards`](https://github.com/asa55/microsoft-identity-platform-docs-as-flashcards)
